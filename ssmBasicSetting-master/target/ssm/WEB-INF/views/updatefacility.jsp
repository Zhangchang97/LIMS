...
<div class="bodywrapper">
        ...
        <ul>
            ...
            <li class="current"><a href="#formsub" class="editor">操作</a>
                ...
                <ul id="formsub">
                    ...
                    <li class="current"><a href="/updatefacility">实验仪器更新</a></li>
                </ul>
            </li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">更新实验仪器信息表格</h1>
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="basicform" class="subcontent">
                ...
                <form class="stdform" action="updatefacility_update" method="post" accept-charset="UTF-8">
                    <p>
                        <label>仪器名称</label>
                        <span class="field">
                            <input type="text" name="name" class="smallinput" value="${facilityinfo.name}"/>
                        </span>
                    </p>
                    ...
                    <p>
                        <label>仪器级别</label>
                        <span class="field">
                            <input type="text" name="level" class="smallinput" value="${facilityinfo.level}"/>
                        </span>
                    </p>
                    ...
                    <p>
                        ...
                        <span class="field">
                            <input type="text" name="totalbooking" class="smallinput" value="${facilityinfo.totalbooking}"/>
                        </span>
                    </p>

                    <input type="text" name="id" value="${facilityinfo.id}" style="visibility: hidden"/>
