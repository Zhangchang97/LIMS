...
<div class="bodywrapper">
    ...
    <div class="vernav2 iconmenu">
        <ul>
            ...
            <li class="current"><a href="#formsub" class="editor">添加课程或仪器</a>
                ...
                <ul id="formsub">
                    <li class="current"><a href="addexperiment">新增实验课程</a></li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">新增实验课程信息表格</h1>
            <span class="pagedesc">按照提示将新增的实验课程的信息填入下列表格中</span>
        </div><!--pageheader-->
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="basicform" class="subcontent">
                ...
                <form class="stdform" action="/addexperiment_add" method="post" accept-charset="UTF-8">
                    <p>
                        <label>课程名称</label>
                        <span class="field">
                            <input type="text" name="coursename" class="smallinput" value=""/>
                        </span>
                    </p>
                    ...
                    <p>
                        <label>实验名称</label>
                        <span class="field">
                            <input type="text" name="experimentname" class="smallinput" value=""/>
                        </span>
                    </p>
                    ...
                    <p>
                        <label>实验仪器</label>
                        <span class="field">
                            <input type="text" name="facility" class="smallinput" value=""/>
                        </span>
                    </p>
                    ...
                    <p>
                        <label>实验仪器数量</label>
                        <span class="field">
                            <input type="text" name="quantityoffacility" class="smallinput" value=""/>
                        </span>
                    ...
                    <p>
                        <label>课程时长</label>
                        <span class="field">
                            <input type="text" name="duration" class="smallinput"value=""/>
                        </span>
                    ...
                    <p>
                        <label>课程教室</label>
                        <span class="field">
                            <input type="text" name="classroom" class="smallinput" value=""/>
                        </span>
